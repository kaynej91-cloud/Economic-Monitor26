...
export const VIEWS = [
  {
    ...
    metrics: [
      ...
      { id: 'U6RATE',    label: 'Broad Unemployment (U-6)', unit: '%', decimals: 1,
        description: 'Includes marginally attached workers and part-time for economic reasons' },
      ...
      { id: 'LNS12300060', label: 'Prime-Age Employment Ratio (25–54)', unit: '%', decimals: 1,
        description: 'Employment-population ratio for ages 25–54, less distorted by retirement trends' },
    ],
